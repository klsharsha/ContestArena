      ...
      <div className={styles.left}>
        <div className={styles.leftContent}>
          ...
          <h2 className={styles.leftTitle}>
            Welcome back to
            <br />
            <span className="text-gradient">ContestArena</span>
          </h2>
          <p className={styles.leftText}>
            Sign in to access your contests, track your rankings,
            and compete with programmers worldwide.
          </p>
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              ...
              <span className={styles.codeVar}>contest</span>
              <span className={styles.codeOp}>.isActive()</span>
              <span className={styles.codeParen}>)</span>
              <span> {'{'}</span>
            </div>
            <div className={styles.codeLine}>
              <span className={styles.codeIndent}>  </span>
              <span className={styles.codeVar}>solve</span>
              <span className={styles.codeParen}>(</span>
              <span className={styles.codeString}>problem</span>
              <span className={styles.codeParen}>)</span>
              <span>;</span>
            </div>
            <div className={styles.codeLine}>
              <span className={styles.codeIndent}>  </span>
              <span className={styles.codeVar}>climbRanks</span>
              <span className={styles.codeParen}>()</span>
              <span>;</span>
            </div>
            <div className={styles.codeLine}>
          ...
          <form onSubmit={handleSubmit} className={styles.form} id="login-form">
            <div className="input-group">
              ...
              {errors.usernameOrEmail && (
                <span className="input-error-text">{errors.usernameOrEmail}</span>
              )}
            </div>
